...
def get_crypto_mines():
    return [
        ...
        ErcotCustomer("Riot Platforms (Corsicana)", "Crypto Mining", "Corsicana", 1000, "Full Buildout (1 GW Capacity)"),
        ErcotCustomer("Marathon Digital (Granbury)", "Crypto Mining", "Granbury", 300, "Wolf Hollow connection"),
        ErcotCustomer("Bitdeer (Rockdale)", "Crypto Mining", "Rockdale", 563, "Full Site Capacity (563 MW)"),
...
def get_datacenters():
    return [
        ...
        ErcotCustomer("CyrusOne Carrollton", "Data Center", "Carrollton", 60, "DFW1 - Largest Carrier Neutral DC (670k sq ft)"),
        ErcotCustomer("CyrusOne Allen", "Data Center", "Allen", 40, "Data Center"),
        ErcotCustomer("Digital Realty Richardson", "Data Center", "Richardson", 70, "Datacenter Park (1M+ sq ft aggregate)"),
        ErcotCustomer("Digital Realty Lewisville", "Data Center", "Lewisville", 60, "Convergence Campus (830k sq ft)"),
        ErcotCustomer("Equinix Dallas", "Data Center", "Dallas", 40, "Data Center"),
        ErcotCustomer("Meta Fort Worth", "Data Center", "Fort Worth", 729, "Full Campus Power Capacity (729 MW)"),
        ErcotCustomer("Meta Temple", "Data Center", "Temple", 90, "Hyperscale (900k sq ft)"),
        ErcotCustomer("Google Midlothian", "Data Center", "Midlothian", 100, "Hyperscale (800k sq ft)"),
        ErcotCustomer("Microsoft San Antonio", "Data Center", "San Antonio", 80, "Texas Research Park (1.5M sq ft)"),
        ErcotCustomer("Google San Antonio", "Data Center", "San Antonio", 40, "Hyperscale"),
        ErcotCustomer("Switch Round Rock", "Data Center", "Round Rock", 185, "Full Campus Capacity (185 MW)"),
        ...
        ErcotCustomer("QTS Irving", "Data Center", "Irving", 50, "Mega-Scale Expansion (700k sq ft)"),
